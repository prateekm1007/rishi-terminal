...
// Macro data — updated as of June 2026
...
export const MACRO_INDICATORS: MacroIndicator[] = [
  {
    ...
    unit: '%',
    trend: 'down',
    trendValue: '-0.22% from last month',
    signal: 'neutral',
  ...
  },
  {
    ...
    unit: '%',
    trend: 'flat',
    trendValue: 'Cut by 25bps — data-driven normalization',
    signal: 'neutral',
    description: 'RBI on extended pause. RBI delivered 25bps cut in Q1 2026 — further easing possible if CPI sustains below 4.5% if CPI falls below 4.5% sustainably.',
    asOf: 'Jun 2026',
  },
  {
