...
const candidates: Candidate[] = [
  ...
  { symbol:"CHEMFAB",    name:"Chemfab Alkalis",              sector:"Chemicals",     exchange:"NSE", price:295,   pe:14,  roe:12, roce:14, mktcap:920,   ocf:50,   rev:600,   revcagr:10, epscagr:12, opm:12, de:0.3, fcf:38,   promo:60.0, ca:350,  tl:200,  sh:31,   np:62,   dep:25,  capex:35,  bvps:180  },
