      ...
      <div className="page-header">
        <div className="content-wrapper">
          ...
          >
            ...
            <div>
              Portfolio “Rishi Ratings” are generated by a multi-philosophy scoring engine (20 Rishis) using the app’s available dataset and heuristics.
              This is for education/research only — not investment advice.
            </div>
      ...
      <div className="content-wrapper" style={{ padding: '28px 24px', maxWidth: 1200 }}>
        ...
        <div className="card-sacred" style={{ padding: 20, marginBottom: 24 }}>
          <div className="philosophy-heading" style={{ fontSize: 14, marginBottom: 6, letterSpacing: 2, color: 'var(--text-muted)' }}>
            PORTFOLIO — AO BY RISHI (WEIGHTED BY CURRENT VALUE)
          </div>
          <div style={{ fontSize: 11, color: 'var(--text-muted)', marginBottom: 14, lineHeight: 1.6 }}>
            Each Rishi’s portfolio score is the weighted average of their stock scores across your holdings (weights = current holding value).
          </div>
